  ...
  return (
    <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-8">
      ...
      >
        ...
        <div className="flex items-center gap-3 p-4">
          <Badge variant="secondary">PILOT PROGRAM</Badge>
        ...
        <div className="flex flex-col p-4 lg:flex-row">
          ...
          <ul className="text-muted-foreground grid gap-4 text-sm lg:w-[70%]">
            {[
              'Tailored deployment for your facility',
              'On-site integration with 1X engineering team',
              'NEO Gamma units configured for your workflows',
              'Priority access to World Model updates',
            ].map((f, i) => (
              <li key={i} className="flex items-center gap-3">
                <FilledCheck />
      ...
      <PricingCard
        ...
        features={[
          ...
          'Access to published papers & datasets',
          'Developer SDK for simulation',
        ]}
        cta="Apply Now"
      ...
      <PricingCard
        ...
        priceSuffix=" /year"
        features={[
          'Fleet deployment across multiple facilities',
          'Dedicated 1X account management team',
      ...
      <PricingCard
        titleBadge="GOVERNMENT"
        priceLabel="Custom"
        priceSuffix=" /contract"
        features={[
          'Defense & public sector programs',
